...
insert into public.products (
  ...
  ('vn-2', 'vietnamese', 'standard-drink', 'Cà Phê Trứng Hà Nội', 'Hanoi Egg Coffee', 'Lòng đỏ trứng tươi đánh bông mịn ngậy quyện cùng espresso nóng thơm lừng.', 'Whipped fresh egg yolk cream layered over piping hot rich espresso.', 45000, 'https://images.unsplash.com/photo-1509785307050-d4066910ec1e?q=80&w=800&auto=format&fit=crop', null, 'Kem trứng, Mật ong, Ca-cao', true, true, 80),
