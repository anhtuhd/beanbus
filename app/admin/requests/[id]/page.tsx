    ...
    return (
      <main className={`wrap ${styles.page}`}>
        <header className={styles.header}>
          ...
          <RequestStatusForm kind="booking" requestId={booking.id} currentStatus={booking.status} />
        </header>
  ...
  return (
    <main className={`wrap ${styles.page}`}>
      <header className={styles.header}>
        ...
        <RequestStatusForm kind="customer" requestId={request.id} currentStatus={request.status} />
      </header>
